 ...
 */
var Ul=Object.defineProperty;var Pc=Object.getOwnPropertyDescriptor;var a2=Object.getOwnPropertyNames;var l2=Object.prototype.hasOwnProperty;var Dl=(t,i)=>{for(var e in i)Ul(t,e,{get:i[e],enumerable:!0})},Bc=(t,i,e,r)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of a2(i))!l2.call(t,n)&&n!==e&&Ul(t,n,{get:()=>i[n],enumerable:!(r=Pc(i,n))||r.enumerable});return t},Vl=(t,i,e)=>(Bc(t,i,"default"),e&&Bc(e,i,"default"));var Nc=(t,i,e,r)=>{for(var n=r>1?void 0:r?Pc(i,e):i,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(r?a(i,e,n):a(n))||n);return r&&n&&Ul(i,e,n),n};var wc={};Dl(wc,{ASTBuilder:()=>Ac,ArrayLiteralExpression:()=>ra,ArrowKind:()=>ci,AssertionExpression:()=>ia,AssertionKind:()=>ui,AtomicRMWOp:()=>gp,BinaryExpression:()=>na,BinaryModule:()=>cl,BinaryOp:()=>hi,BlockStatement:()=>Ba,BrOnOp:()=>Py,BreakStatement:()=>Pa,CallExpression:()=>sa,Class:()=>Kt,ClassDeclaration:()=>hn,ClassExpression:()=>aa,ClassPrototype:()=>Wn,CommaExpression:()=>la,CommentKind:()=>pp,CommentNode:()=>ta,CommonFlags:()=>Ve,CommonNames:()=>B,CompiledExpression:()=>wa,Compiler:()=>fs,ConditionKind:()=>Lp,ConstantValueKind:()=>Up,Constraints:()=>Sc,ConstructorExpression:()=>oa,ContinueStatement:()=>Na,DEFAULT_STACK_SIZE:()=>qI,DeclarationStatement:()=>We,DeclaredElement:()=>Ht,DecoratorFlags:()=>jt,DecoratorKind:()=>Tt,DecoratorNode:()=>ea,DiagnosticCategory:()=>Qs,DiagnosticCode:()=>st,DiagnosticEmitter:()=>qe,DiagnosticMessage:()=>Ys,DoStatement:()=>La,Element:()=>Dn,ElementAccessExpression:()=>ua,ElementKind:()=>ut,EmptyStatement:()=>Ma,Enum:()=>kl,EnumDeclaration:()=>Ga,EnumValue:()=>Al,EnumValueDeclaration:()=>za,ExportDefaultStatement:()=>qa,ExportImportStatement:()=>Ua,ExportMember:()=>Da,ExportNames:()=>cs,ExportStatement:()=>Va,Expression:()=>de,ExpressionId:()=>yr,ExpressionRunnerFlags:()=>_l,ExpressionStatement:()=>Oa,ExternalKind:()=>yp,FEATURES_ALL:()=>a0,FEATURES_DEFAULT:()=>l0,FEATURE_BULK_MEMORY:()=>$I,FEATURE_EXCEPTION_HANDLING:()=>YI,FEATURE_EXTENDED_CONST:()=>n0,FEATURE_GC:()=>t0,FEATURE_MEMORY64:()=>r0,FEATURE_MULTI_VALUE:()=>e0,FEATURE_MUTABLE_GLOBALS:()=>HI,FEATURE_NONTRAPPING_F2I:()=>jI,FEATURE_REFERENCE_TYPES:()=>JI,FEATURE_RELAXED_SIMD:()=>i0,FEATURE_SIGN_EXTENSION:()=>KI,FEATURE_SIMD:()=>XI,FEATURE_STRINGREF:()=>s0,FEATURE_TAIL_CALLS:()=>QI,FEATURE_THREADS:()=>ZI,FalseExpression:()=>Ra,Feature:()=>Ut,FeatureFlags:()=>mp,FieldDeclaration:()=>Wa,FieldFlags:()=>Np,File:()=>qn,FloatLiteralExpression:()=>pa,Flow:()=>St,FlowFlags:()=>xl,ForOfStatement:()=>Ha,ForStatement:()=>Ka,Function:()=>ct,FunctionDeclaration:()=>dn,FunctionExpression:()=>ca,FunctionPrototype:()=>je,FunctionTypeNode:()=>dr,GETTER_PREFIX:()=>Us,Global:()=>br,HeapTypeRef:()=>ue,INDEX_SUFFIX:()=>Le,INNER_DELIMITER:()=>Xu,INSTANCE_DELIMITER:()=>$u,IdentifierExpression:()=>Oe,IdentifierHandling:()=>_p,IfStatement:()=>ja,ImportDeclaration:()=>$a,ImportNames:()=>Ci,ImportStatement:()=>mn,IndexSignature:()=>Ln,IndexSignatureNode:()=>Ca,InstanceOfExpression:()=>_a,IntegerLiteralExpression:()=>fa,Interface:()=>Mn,InterfaceDeclaration:()=>Xa,InterfacePrototype:()=>wl,JSBuilder:()=>Fi,LIBRARY_PREFIX:()=>nt,LIBRARY_SUBST:()=>Vs,LiteralExpression:()=>at,LiteralKind:()=>Vt,Local:()=>Ue,LocalFlags:()=>Bn,MemorySegment:()=>fi,MethodDeclaration:()=>mr,Module:()=>Ot,ModuleDeclaration:()=>rl,NamedTypeNode:()=>hr,Namespace:()=>On,NamespaceDeclaration:()=>Za,NewExpression:()=>ha,Node:()=>L,NodeKind:()=>xt,NullExpression:()=>da,ObjectLiteralExpression:()=>ma,OmittedExpression:()=>ya,OperatorKind:()=>Re,Options:()=>_s,PARENT_SUBST:()=>d2,PATH_DELIMITER:()=>Ye,PackedType:()=>xn,Parameter:()=>zp,ParameterKind:()=>oi,ParameterNode:()=>ai,ParenthesizedExpression:()=>ga,Parser:()=>zn,Precedence:()=>Oy,Program:()=>Un,Property:()=>Nn,PropertyAccessExpression:()=>ba,PropertyPrototype:()=>bi,Range:()=>le,RefAsOp:()=>By,RegexpLiteralExpression:()=>xa,Relooper:()=>pl,ReportMode:()=>Sl,Resolver:()=>Pn,ReturnStatement:()=>Ya,Runtime:()=>Gs,RuntimeFeatures:()=>Ic,SETTER_PREFIX:()=>Ds,SIMDExtractOp:()=>bp,SIMDLoadOp:()=>Ep,SIMDLoadStoreLaneOp:()=>vp,SIMDReplaceOp:()=>xp,SIMDShiftOp:()=>Tp,SIMDTernaryOp:()=>Sp,STATIC_DELIMITER:()=>an,STUB_DELIMITER:()=>Zu,SideEffects:()=>Pp,Signature:()=>De,Source:()=>fe,SourceKind:()=>pi,State:()=>ol,Statement:()=>oe,StringAsOp:()=>zy,StringEncodeOp:()=>My,StringEqOp:()=>Gy,StringIterMoveOp:()=>Uy,StringLiteralExpression:()=>Ea,StringMeasureOp:()=>Ly,StringNewOp:()=>Ny,StringSliceWTFOp:()=>Dy,SuperExpression:()=>va,SwitchBuilder:()=>Tn,SwitchCase:()=>Qa,SwitchStatement:()=>Ja,TSDBuilder:()=>Bi,Target:()=>Zr,TemplateLiteralExpression:()=>Sa,TernaryExpression:()=>Ta,ThisExpression:()=>Ia,ThrowStatement:()=>el,Token:()=>_i,Tokenizer:()=>gn,TrueExpression:()=>Fa,TryStatement:()=>tl,Type:()=>u,TypeBuilderErrorReason:()=>dp,TypeDeclaration:()=>il,TypeDefinition:()=>Xe,TypeFlags:()=>pt,TypeKind:()=>Wt,TypeName:()=>si,TypeNode:()=>_n,TypeParameterNode:()=>Js,TypeRef:()=>P,TypedElement:()=>Ft,Typeinfo:()=>Yr,TypeinfoFlags:()=>zs,UnaryExpression:()=>fn,UnaryOp:()=>En,UnaryPostfixExpression:()=>ka,UnaryPrefixExpression:()=>Aa,UncheckedBehavior:()=>Tl,VariableDeclaration:()=>nl,VariableLikeDeclarationStatement:()=>li,VariableLikeElement:()=>xr,VariableStatement:()=>sl,VoidStatement:()=>al,WhileStatement:()=>ll,addGlobalAlias:()=>MI,allocPtrArray:()=>_e,buildJS:()=>L0,buildTSD:()=>N0,compile:()=>P0,createType:()=>Ke,defaultFeatures:()=>Ml,diagnosticCategoryToColor:()=>ky,diagnosticCategoryToString:()=>up,diagnosticCodeToString:()=>qs,ensureType:()=>Cn,expandType:()=>Ip,featureToString:()=>Xr,findDecorator:()=>Et,formatDiagnostic:()=>Ay,formatDiagnosticMessage:()=>Ay,getBinaryLeft:()=>He,getBinaryOp:()=>di,getBinaryRight:()=>Pe,getBinaryenModuleRef:()=>M0,getBlockChildAt:()=>kn,getBlockChildCount:()=>Rn,getBlockName:()=>Fn,getBreakCondition:()=>Z2,getBreakName:()=>X2,getCallOperandAt:()=>ze,getCallOperandCount:()=>ot,getCallTarget:()=>wn,getConstValueF32:()=>ge,getConstValueF64:()=>be,getConstValueI32:()=>ee,getConstValueI64High:()=>Be,getConstValueI64Low:()=>Ee,getConstValueV128:()=>Fp,getDefaultParameterName:()=>jy,getDependee:()=>C0,getDiagnosticCategory:()=>g0,getDiagnosticCode:()=>y0,getDiagnosticMessage:()=>b0,getDiagnosticRange:()=>x0,getDiagnosticRelatedRange:()=>T0,getDropValue:()=>Q2,getExpressionId:()=>Q,getExpressionType:()=>ie,getFunctionBody:()=>tx,getFunctionName:()=>Cp,getFunctionParams:()=>rx,getFunctionResults:()=>ix,getFunctionVars:()=>nx,getGlobalGetName:()=>Sn,getGlobalInit:()=>lx,getGlobalName:()=>sx,getGlobalType:()=>ax,getIfCondition:()=>yl,getIfFalse:()=>mi,getIfTrue:()=>An,getLoadBytes:()=>Rp,getLoadOffset:()=>V2,getLoadPtr:()=>q2,getLocalGetIndex:()=>lt,getLocalSetIndex:()=>dl,getLocalSetValue:()=>gr,getLoopBody:()=>$2,getLoopName:()=>j2,getMemoryGrowDelta:()=>ex,getRangeEnd:()=>v0,getRangeSource:()=>S0,getRangeStart:()=>E0,getReturnValue:()=>J2,getSelectCondition:()=>Y2,getSelectElse:()=>wp,getSelectThen:()=>Ap,getSideEffects:()=>yi,getSource:()=>m0,getSourceNormalizedPath:()=>I0,getStoreBytes:()=>O2,getStoreOffset:()=>W2,getStorePtr:()=>K2,getStoreValue:()=>H2,getTagName:()=>ox,getTagParams:()=>ux,getTagResults:()=>px,getUnaryOp:()=>In,getUnaryValue:()=>ml,initializeProgram:()=>B0,isConstExpressionNaN:()=>hl,isConstNaN:()=>D2,isConstNegZero:()=>fl,isConstNonZero:()=>et,isConstZero:()=>Fe,isDeclaredElement:()=>Vn,isError:()=>k0,isGlobalMutable:()=>Bp,isIllegalVariableIdentifier:()=>fp,isInfo:()=>F0,isLoadSigned:()=>kp,isLocalTee:()=>vn,isNullableType:()=>Vy,isTypeOmitted:()=>Ie,isTypedElement:()=>El,isWarning:()=>R0,mangleInternalName:()=>Ne,mangleInternalPath:()=>yn,mustPreserveSideEffects:()=>gl,newOptions:()=>TI,newProgram:()=>h0,nextDiagnostic:()=>d0,nextFile:()=>w0,operatorTokenToString:()=>Te,optimize:()=>z0,parse:()=>A0,readString:()=>Ge,removeGlobalAlias:()=>GI,runtimeFunctions:()=>Ri,runtimeGlobals:()=>ki,setBasenameHint:()=>p0,setBindingsHint:()=>c0,setBundleVersion:()=>WI,setDebugInfo:()=>f0,setExportMemory:()=>II,setExportRuntime:()=>VI,setExportStart:()=>zI,setExportTable:()=>CI,setFeature:()=>o0,setImportMemory:()=>FI,setImportTable:()=>wI,setInitialMemory:()=>RI,setLowMemoryLimit:()=>DI,setMaximumMemory:()=>kI,setMemoryBase:()=>NI,setNoAssert:()=>SI,setNoUnsafe:()=>UI,setOptimizeLevelHints:()=>u0,setPedantic:()=>_0,setRuntime:()=>vI,setSharedMemory:()=>AI,setSourceMap:()=>BI,setStackSize:()=>OI,setTableBase:()=>LI,setTarget:()=>EI,setUncheckedBehavior:()=>PI,tokenFromKeyword:()=>wy,tokenIsAlsoIdentifier:()=>Cy,typesToRefs:()=>Tr,typesToString:()=>vl,util:()=>op,validate:()=>G0});var Z=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof Z.ASC_TARGET>"u"){let e=function(){Error.captureStackTrace?Error.captureStackTrace(this,e):this.stack=this.name+": "+this.message+`
...
`),U(n,--this.indentLevel),n.push(`))({}),
`),this.visitNamespace(e,r)}makeGlobalImport(e,r,n){let s=this.sb,a=n.type;U(s,this.indentLevel),Me(r)?s.push(r):(s.push('"'),s.push(ye(r,34)),s.push('": '));let l=this.ensureModuleId(e);zr(a,0)?(s.push(`(
...
`),U(s,--this.indentLevel),s.push("}")),s.push(`,
`)}makeFunctionImport(e,r,n,s=null){let a=this.sb,l=n.signature;if(U(a,this.indentLevel),Me(r)?a.push(r):(a.push('"'),a.push(ye(r,34)),a.push('"')),kc(l,0)&&!s&&Me(r))a.push(`: (
...
`);let o=a.length;for(let S=Map_keys(r),x=0,E=S.length;x<E;++x){let F=S[x],I=this.ensureModuleId(F),R=r.get(F);if(U(a,this.indentLevel),Me(F)?a.push(F):(a.push('"'),a.push(ye(F,34)),a.push('"')),!xI(F)){a.push(": __module"),a.push(I.toString()),a.push(`,
...
`),++this.indentLevel;let N=0;for(let V=Map_keys(R),K=0,D=V.length;K<D;++K){let O=V[K],X=assert(R.get(O));if(X.kind==5){let te=X,Y=this.getExternalCode(te);(!kc(te.signature,0)||!Me(O)||Y)&&(this.makeFunctionImport(F,O,X,Y),++N)}else if(X.kind==0){let te=X;(!zr(te.type,0)||!Me(O))&&(this.makeGlobalImport(F,O,te),++N)}}--this.indentLevel,N?(U(a,this.indentLevel),a.push(`}),
...
`)):a.length=o-2;let c=this.importMappings,_=new Array;for(let S=Map_keys(c),x=0,E=S.length;x<E;++x){let F=S[x];if(F=="env")_.push(`  const env = imports.env;
...
`)),_.push("  const __module"),_.push(I.toString()),_.push(" = imports"),Me(F)?(_.push("."),_.push(F)):(_.push('["'),_.push(ye(F,34)),_.push('"]')),_.push(`;
...
`)}if(this.needsLiftString){let S=n.OBJECTInstance,x=S.offsetof("rtSize")-S.nextMemoryOffset,E=1024;a.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLiftArray){let S=n.arrayBufferViewInstance.offsetof("dataStart"),x=n.arrayBufferViewInstance.nextMemoryOffset;this.needsGetU32=!0,a.push(`  function __liftArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLowerArray){let S=n.arrayBufferInstance.id,x=n.arrayBufferViewInstance,E=x.nextMemoryOffset+4,F=x.offsetof("buffer"),I=x.offsetof("dataStart"),R=x.offsetof("byteLength"),C=R+4;this.needsSetU32=!0,a.push(`  function __lowerArray(lowerElement, id, align, values) {
...
`)}if(this.needsLiftTypedArray){let S=n.arrayBufferViewInstance,x=S.offsetof("dataStart"),E=S.offsetof("byteLength");this.needsGetU32=!0,a.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
...
`)}if(this.needsLowerTypedArray){let S=n.arrayBufferInstance.id,x=n.arrayBufferViewInstance,E=x.nextMemoryOffset,F=x.offsetof("buffer"),I=x.offsetof("dataStart"),R=x.offsetof("byteLength");this.needsSetU32=!0,a.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${S})) >>> 0,
...
`)}if(this.needsLiftStaticArray){let S=n.OBJECTInstance,x=S.offsetof("rtSize")-S.nextMemoryOffset;this.needsGetU32=!0,a.push(`  function __liftStaticArray(liftElement, align, pointer) {
    if (!pointer) return null;
    const
...
`),this.program.options.exportRuntime){for(let E=0,F=Ri.length;E<F;++E)a.push("  "),a.push(Ri[E]),a.push(`,
`);for(let E=0,F=ki.length;E<F;++E)a.push("  "),a.push(ki[E]),a.push(`,
...
`);let S=!1,x=new Array;for(let E=Map_keys(c),F=0,I=E.length;F<I;++F){let R=E[F];if(R=="env")U(a,2),a.push(`env: globalThis,
`);else{let C=this.ensureModuleId(R);U(a,2),Me(R)?a.push(R):(a.push('"'),a.push(ye(R,34)),a.push('"')),a.push(": __maybeDefault(__import"),a.push(C.toString()),a.push(`),
`),x.push("import * as __import"),x.push(C.toString()),x.push(' from "'),x.push(ye(bI(R),34)),x.push(`";
`),S=!0}}a[0]=x.join(""),a.push(`  }
...
`),r.join("")}makeLowerRecord(e){assert(ps(e));let r=new Array;U(r,this.indentLevel),r.push("function __lowerRecord"),r.push(e.id.toString()),r.push(`(value) {
`),U(r,++this.indentLevel),r.push("// "),r.push(e.type.toString()),r.push(`
...
`)}else e.push(`
`);U(e,this.indentLevel)}serializeParameter(i){let e=this.sb,r=i.parameterKind,n=i.implicitFieldDeclaration;n&&this.serializeAccessModifiers(n),r==2&&e.push("..."),this.visitIdentifierExpression(i.name);let s=i.type,a=i.initializer;s&&(r==1&&!a&&e.push("?"),Ie(s)||(e.push(": "),this.visitTypeNode(s))),a&&(e.push(" = "),this.visitNode(a))}serializeExternalModifiers(i){let e=this.sb;i.is(2)?e.push("export "):i.is(1)?e.push("import "):i.is(4)&&e.push("declare ")}serializeAccessModifiers(i){let e=this.sb;i.is(4)&&e.push("declare "),i.is(256)?e.push("public "):i.is(512)?e.push("private "):i.is(1024)&&e.push("protected "),i.is(32)?e.push("static "):i.is(128)&&e.push("abstract "),i.is(64)&&e.push("readonly ")}finish(){let i=this.sb.join("");return this.sb=[],i}};var nK=wc;export{Ac as ASTBuilder,ra as ArrayLiteralExpression,ci as ArrowKind,ia as AssertionExpression,ui as AssertionKind,gp as AtomicRMWOp,na as BinaryExpression,cl as BinaryModule,hi as BinaryOp,Ba as BlockStatement,Py as BrOnOp,Pa as BreakStatement,sa as CallExpression,Kt as Class,hn as ClassDeclaration,aa as ClassExpression,Wn as ClassPrototype,la as CommaExpression,pp as CommentKind,ta as CommentNode,Ve as CommonFlags,B as CommonNames,wa as CompiledExpression,fs as Compiler,Lp as ConditionKind,Up as ConstantValueKind,Sc as Constraints,oa as ConstructorExpression,Na as ContinueStatement,qI as DEFAULT_STACK_SIZE,We as DeclarationStatement,Ht as DeclaredElement,jt as DecoratorFlags,Tt as DecoratorKind,ea as DecoratorNode,Qs as DiagnosticCategory,st as DiagnosticCode,qe as DiagnosticEmitter,Ys as DiagnosticMessage,La as DoStatement,Dn as Element,ua as ElementAccessExpression,ut as ElementKind,Ma as EmptyStatement,kl as Enum,Ga as EnumDeclaration,Al as EnumValue,za as EnumValueDeclaration,qa as ExportDefaultStatement,Ua as ExportImportStatement,Da as ExportMember,cs as ExportNames,Va as ExportStatement,de as Expression,yr as ExpressionId,_l as ExpressionRunnerFlags,Oa as ExpressionStatement,yp as ExternalKind,a0 as FEATURES_ALL,l0 as FEATURES_DEFAULT,$I as FEATURE_BULK_MEMORY,YI as FEATURE_EXCEPTION_HANDLING,n0 as FEATURE_EXTENDED_CONST,t0 as FEATURE_GC,r0 as FEATURE_MEMORY64,e0 as FEATURE_MULTI_VALUE,HI as FEATURE_MUTABLE_GLOBALS,jI as FEATURE_NONTRAPPING_F2I,JI as FEATURE_REFERENCE_TYPES,i0 as FEATURE_RELAXED_SIMD,KI as FEATURE_SIGN_EXTENSION,XI as FEATURE_SIMD,s0 as FEATURE_STRINGREF,QI as FEATURE_TAIL_CALLS,ZI as FEATURE_THREADS,Ra as FalseExpression,Ut as Feature,mp as FeatureFlags,Wa as FieldDeclaration,Np as FieldFlags,qn as File,pa as FloatLiteralExpression,St as Flow,xl as FlowFlags,Ha as ForOfStatement,Ka as ForStatement,ct as Function,dn as FunctionDeclaration,ca as FunctionExpression,je as FunctionPrototype,dr as FunctionTypeNode,Us as GETTER_PREFIX,br as Global,ue as HeapTypeRef,Le as INDEX_SUFFIX,Xu as INNER_DELIMITER,$u as INSTANCE_DELIMITER,Oe as IdentifierExpression,_p as IdentifierHandling,ja as IfStatement,$a as ImportDeclaration,Ci as ImportNames,mn as ImportStatement,Ln as IndexSignature,Ca as IndexSignatureNode,_a as InstanceOfExpression,fa as IntegerLiteralExpression,Mn as Interface,Xa as InterfaceDeclaration,wl as InterfacePrototype,Fi as JSBuilder,nt as LIBRARY_PREFIX,Vs as LIBRARY_SUBST,at as LiteralExpression,Vt as LiteralKind,Ue as Local,Bn as LocalFlags,fi as MemorySegment,mr as MethodDeclaration,Ot as Module,rl as ModuleDeclaration,hr as NamedTypeNode,On as Namespace,Za as NamespaceDeclaration,ha as NewExpression,L as Node,xt as NodeKind,da as NullExpression,ma as ObjectLiteralExpression,ya as OmittedExpression,Re as OperatorKind,_s as Options,d2 as PARENT_SUBST,Ye as PATH_DELIMITER,xn as PackedType,zp as Parameter,oi as ParameterKind,ai as ParameterNode,ga as ParenthesizedExpression,zn as Parser,Oy as Precedence,Un as Program,Nn as Property,ba as PropertyAccessExpression,bi as PropertyPrototype,le as Range,By as RefAsOp,xa as RegexpLiteralExpression,pl as Relooper,Sl as ReportMode,Pn as Resolver,Ya as ReturnStatement,Gs as Runtime,Ic as RuntimeFeatures,Ds as SETTER_PREFIX,bp as SIMDExtractOp,Ep as SIMDLoadOp,vp as SIMDLoadStoreLaneOp,xp as SIMDReplaceOp,Tp as SIMDShiftOp,Sp as SIMDTernaryOp,an as STATIC_DELIMITER,Zu as STUB_DELIMITER,Pp as SideEffects,De as Signature,fe as Source,pi as SourceKind,ol as State,oe as Statement,zy as StringAsOp,My as StringEncodeOp,Gy as StringEqOp,Uy as StringIterMoveOp,Ea as StringLiteralExpression,Ly as StringMeasureOp,Ny as StringNewOp,Dy as StringSliceWTFOp,va as SuperExpression,Tn as SwitchBuilder,Qa as SwitchCase,Ja as SwitchStatement,Bi as TSDBuilder,Zr as Target,Sa as TemplateLiteralExpression,Ta as TernaryExpression,Ia as ThisExpression,el as ThrowStatement,_i as Token,gn as Tokenizer,Fa as TrueExpression,tl as TryStatement,u as Type,dp as TypeBuilderErrorReason,il as TypeDeclaration,Xe as TypeDefinition,pt as TypeFlags,Wt as TypeKind,si as TypeName,_n as TypeNode,Js as TypeParameterNode,P as TypeRef,Ft as TypedElement,Yr as Typeinfo,zs as TypeinfoFlags,fn as UnaryExpression,En as UnaryOp,ka as UnaryPostfixExpression,Aa as UnaryPrefixExpression,Tl as UncheckedBehavior,nl as VariableDeclaration,li as VariableLikeDeclarationStatement,xr as VariableLikeElement,sl as VariableStatement,al as VoidStatement,ll as WhileStatement,MI as addGlobalAlias,_e as allocPtrArray,L0 as buildJS,N0 as buildTSD,P0 as compile,Ke as createType,nK as default,Ml as defaultFeatures,ky as diagnosticCategoryToColor,up as diagnosticCategoryToString,qs as diagnosticCodeToString,Cn as ensureType,Ip as expandType,Xr as featureToString,Et as findDecorator,Ay as formatDiagnostic,Ay as formatDiagnosticMessage,He as getBinaryLeft,di as getBinaryOp,Pe as getBinaryRight,M0 as getBinaryenModuleRef,kn as getBlockChildAt,Rn as getBlockChildCount,Fn as getBlockName,Z2 as getBreakCondition,X2 as getBreakName,ze as getCallOperandAt,ot as getCallOperandCount,wn as getCallTarget,ge as getConstValueF32,be as getConstValueF64,ee as getConstValueI32,Be as getConstValueI64High,Ee as getConstValueI64Low,Fp as getConstValueV128,jy as getDefaultParameterName,C0 as getDependee,g0 as getDiagnosticCategory,y0 as getDiagnosticCode,b0 as getDiagnosticMessage,x0 as getDiagnosticRange,T0 as getDiagnosticRelatedRange,Q2 as getDropValue,Q as getExpressionId,ie as getExpressionType,tx as getFunctionBody,Cp as getFunctionName,rx as getFunctionParams,ix as getFunctionResults,nx as getFunctionVars,Sn as getGlobalGetName,lx as getGlobalInit,sx as getGlobalName,ax as getGlobalType,yl as getIfCondition,mi as getIfFalse,An as getIfTrue,Rp as getLoadBytes,V2 as getLoadOffset,q2 as getLoadPtr,lt as getLocalGetIndex,dl as getLocalSetIndex,gr as getLocalSetValue,$2 as getLoopBody,j2 as getLoopName,ex as getMemoryGrowDelta,v0 as getRangeEnd,S0 as getRangeSource,E0 as getRangeStart,J2 as getReturnValue,Y2 as getSelectCondition,wp as getSelectElse,Ap as getSelectThen,yi as getSideEffects,m0 as getSource,I0 as getSourceNormalizedPath,O2 as getStoreBytes,W2 as getStoreOffset,K2 as getStorePtr,H2 as getStoreValue,ox as getTagName,ux as getTagParams,px as getTagResults,In as getUnaryOp,ml as getUnaryValue,B0 as initializeProgram,hl as isConstExpressionNaN,D2 as isConstNaN,fl as isConstNegZero,et as isConstNonZero,Fe as isConstZero,Vn as isDeclaredElement,k0 as isError,Bp as isGlobalMutable,fp as isIllegalVariableIdentifier,F0 as isInfo,kp as isLoadSigned,vn as isLocalTee,Vy as isNullableType,Ie as isTypeOmitted,El as isTypedElement,R0 as isWarning,Ne as mangleInternalName,yn as mangleInternalPath,gl as mustPreserveSideEffects,TI as newOptions,h0 as newProgram,d0 as nextDiagnostic,w0 as nextFile,Te as operatorTokenToString,z0 as optimize,A0 as parse,Ge as readString,GI as removeGlobalAlias,Ri as runtimeFunctions,ki as runtimeGlobals,p0 as setBasenameHint,c0 as setBindingsHint,WI as setBundleVersion,f0 as setDebugInfo,II as setExportMemory,VI as setExportRuntime,zI as setExportStart,CI as setExportTable,o0 as setFeature,FI as setImportMemory,wI as setImportTable,RI as setInitialMemory,DI as setLowMemoryLimit,kI as setMaximumMemory,NI as setMemoryBase,SI as setNoAssert,UI as setNoUnsafe,u0 as setOptimizeLevelHints,_0 as setPedantic,vI as setRuntime,AI as setSharedMemory,BI as setSourceMap,OI as setStackSize,LI as setTableBase,EI as setTarget,PI as setUncheckedBehavior,wy as tokenFromKeyword,Cy as tokenIsAlsoIdentifier,Tr as typesToRefs,vl as typesToString,op as util,G0 as validate};
