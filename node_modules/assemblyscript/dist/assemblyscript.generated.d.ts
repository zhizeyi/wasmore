...
declare module "types:assemblyscript/src/tokenizer" {
    ...
    export const enum Token {
        ...
        Do = 15,// ES2017
        Else = 16,// ES2017
        Enum = 17,// ES2017 future
        Export = 18,// ES2017
        Extends = 19,// ES2017
        False = 20,// ES
        Finally = 21,// ES2017
        For = 22,// ES2017
        From = 23,// AS possible identifier
        Function = 24,// ES2017
        Get = 25,
        If = 26,// ES2017
        Implements = 27,// ES2017 non-lexical
        Import = 28,// ES2017
        In = 29,// ES2017
        InstanceOf = 30,// ES2017
        Interface = 31,// ES2017 non-lexical
        Is = 32,
        KeyOf = 33,
        Let = 34,// ES2017 non-lexical
        Module = 35,// AS possible identifier
        Namespace = 36,// AS possible identifier
        New = 37,// ES2017
        Null = 38,// ES
        Of = 39,
        Override = 40,
        Package = 41,// ES2017 non-lexical
        Private = 42,// ES2017 non-lexical
        Protected = 43,// ES2017 non-lexical
        Public = 44,// ES2017 non-lexical
        Readonly = 45,
        Return = 46,// ES2017
        Set = 47,
        Static = 48,// ES2017 non-lexical
        Super = 49,// ES2017
        Switch = 50,// ES2017
        This = 51,// ES2017
        Throw = 52,// ES2017
        True = 53,// ES
        Try = 54,// ES2017
        Type = 55,// AS possible identifier
        TypeOf = 56,// ES2017
        Var = 57,// ES2017
        Void = 58,// ES2017
        While = 59,// ES2017
...
declare module "types:assemblyscript/src/types" {
     ...
     * @license Apache-2.0
     */
    import { Class, Program, OperatorKind, Function } from "types:assemblyscript/src/program";
...
declare module "types:assemblyscript/src/flow" {
    ...
    export const enum FlowFlags {
        ...
        Terminates = 256,// Note that this doesn't cover BREAKS, which is separate
...
declare module "types:assemblyscript/src/program" {
    ...
    export enum OperatorKind {
        ...
        IndexedGet = 1,// a[]
        IndexedSet = 2,// a[]=b
        UncheckedIndexedGet = 3,// unchecked(a[])
        UncheckedIndexedSet = 4,// unchecked(a[]=b)
        Add = 5,// a + b
        Sub = 6,// a - b
        Mul = 7,// a * b
        Div = 8,// a / b
...
declare module "types:assemblyscript/src/module" {
    ...
    export class SwitchBuilder {
        ...
        addOrReplaceCase(value: number, code: ExpressionRef[]): void;
...
declare module "types:assemblyscript/std/assembly/shared/feature" {
    ...
    export const enum Feature {
        ...
        None = 0,
        /** Sign extension operations. */
        SignExtension = 1,// see: https://github.com/WebAssembly/sign-extension-ops
        /** Mutable global imports and exports. */
        MutableGlobals = 2,// see: https://github.com/WebAssembly/mutable-global
        /** Non-trapping float to integer operations. */
        NontrappingF2I = 4,// see: https://github.com/WebAssembly/nontrapping-float-to-int-conversions
        /** Bulk memory operations. */
        BulkMemory = 8,// see: https://github.com/WebAssembly/bulk-memory-operations
        /** SIMD types and operations. */
        Simd = 16,// see: https://github.com/WebAssembly/simd
        /** Threading and atomic operations. */
        Threads = 32,// see: https://github.com/WebAssembly/threads
        /** Exception handling operations. */
        ExceptionHandling = 64,// see: https://github.com/WebAssembly/exception-handling
        /** Tail call operations. */
        TailCalls = 128,// see: https://github.com/WebAssembly/tail-call
        /** Reference types. */
        ReferenceTypes = 256,// see: https://github.com/WebAssembly/reference-types
        /** Multi value types. */
        MultiValue = 512,// see: https://github.com/WebAssembly/multi-value
        /** Garbage collection. */
        GC = 1024,// see: https://github.com/WebAssembly/gc
        /** Memory64. */
        Memory64 = 2048,// see: https://github.com/WebAssembly/memory64
        /** Relaxed SIMD. */
        RelaxedSimd = 4096,// see: https://github.com/WebAssembly/relaxed-simd
        /** Extended const expressions. */
        ExtendedConst = 8192,// see: https://github.com/WebAssembly/extended-const
        /** Reference typed strings. */
        Stringref = 16384,// see: https://github.com/WebAssembly/stringref
        /** All features. */
        All = 32767
    }
